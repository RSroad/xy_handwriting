...
**
** Created: Thu Nov 24 13:09:59 2011
...
static const char qt_meta_stringdata_DrawWidget[] = {
    "DrawWidget\0\0clickWithString(QString)\0"
    "setStyle(int)\0setWidth(int)\0"
    "setColor(QColor)\0clear()\0next()\0prev()\0"
    "pressBtn(QString)\0"
};
...
int DrawWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: clickWithString((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: setStyle((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: setWidth((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: setColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        case 4: clear(); break;
        case 5: next(); break;
        case 6: prev(); break;
        case 7: pressBtn((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 8;
    }
...
// SIGNAL 0
void DrawWidget::clickWithString(QString _t1)
{
